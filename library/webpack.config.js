  ...
  return {
    ...
    plugins: [
      new HtmlWebpackPlugin({
        template: env.ai ? 'ai.html' : env === 'geoda' ? 'geoda.html' : 'index.html'
      }),
      ...
      new webpack.EnvironmentPlugin(['NEXT_PUBLIC_MAPBOX_TOKEN', 'EnableLogger', 'OPEN_AI_TOKEN'])
    ],
    resolve: {
      extensions: ['.js', '.tsx', '.ts'],
      modules: ['node_modules', resolve(__dirname, '../../csds_kepler/src')],
      alias: {
        'apache-arrow': resolve(__dirname, '../geoda-ai/node_modules/apache-arrow'),
        tailwindcss: resolve(__dirname, './node_modules/tailwindcss'),
        '@nextui-org/react': resolve(__dirname, './node_modules/@nextui-org/react'),
        react: resolve(__dirname, './node_modules/react'),
        'react-dom': resolve(__dirname, './node_modules/react-dom'),
        'react-redux': resolve(__dirname, '../geoda-ai/node_modules/react-redux'),
        'styled-components': resolve(__dirname, '../geoda-ai/node_modules/styled-components'),
        ...
        '@loaders.gl/csv': resolve(__dirname, '../../loaders.gl/modules/csv/src'),
        ...
        '@/constants': resolve(__dirname, '../geoda-ai/src/constants'),
        '@/ai': resolve(__dirname, '../geoda-ai/src/ai'),
        '@/utils': resolve(__dirname, '../geoda-ai/src/utils')
      }
    },
    module: {
      rules: [
